...
function renderCapture(display, targetContainerId) {
    ...
    // Clear the paint canvas before drawing
    //ppaintCanvas.clear();


    // Apply the image pixels to the paint canvas based on colors
    // Loop through each pixel of the posterized image - 
    // this part applies one shape to each pixel one at a time
    // adjust the shapes as needed
        ...
        for (let y = 0; y < img.height; y++) {
            ...
            if (colorCategory === 'red') {
                ...
                for (let i = 0; i < 10; i++) {
                    ...
                    paintCanvas.strokeWeight(1);
                    paintCanvas.noFill();
                    paintCanvas.stroke(235, 64, 52, 30);
                    paintCanvas.ellipse(mappedX, mappedY, brushSize, brushSize /2);
                    paintCanvas.pop();
                }
            } else if (colorCategory === 'orange') {
                // Draw orange circles
                ...
                paintCanvas.strokeWeight(1);
                paintCanvas.noFill();
                paintCanvas.stroke(255, 140, 0, 50);
                paintCanvas.ellipse(mappedX, mappedY, brushSize);
                paintCanvas.pop();
            } else if (colorCategory === 'yellow') {
                // Draw yellow flowers
                ...
                //no fill
                paintCanvas.noFill();
                paintCanvas.stroke(255, 247, 0, 40);
                paintCanvas.translate(mappedX, mappedY);
                for (let i = 0; i < 10; i++) {
                ...
                paintCanvas.strokeWeight(1);
                paintCanvas.noFill();
                paintCanvas.stroke(125, 164, 120, 50);
                paintCanvas.quad(mappedX, mappedY, mappedX + brushSize, mappedY, mappedX + brushSize, mappedY + brushSize, mappedX, mappedY + brushSize);
                paintCanvas.pop();
            } else if (colorCategory === 'cyan') {
                // Draw cyan long rects
                ...
                paintCanvas.strokeWeight(1);
                paintCanvas.noFill();
                paintCanvas.stroke(34, 212, 194, 50);
                paintCanvas.rect(mappedX, mappedY, brushSize, brushSize * 2);
                paintCanvas.pop();
            } else if (colorCategory === 'blue') {
                // Draw blue triangles
                ...
                paintCanvas.strokeWeight(1);
                paintCanvas.noFill();
                paintCanvas.stroke(34, 129, 212, 50);
                paintCanvas.triangle(mappedX, mappedY, mappedX + brushSize, mappedY, mappedX + brushSize / 2, mappedY - brushSize);
                paintCanvas.pop();
            } else if (colorCategory === 'purple') {
                // Draw purple hollow circles
                ...
                paintCanvas.strokeWeight(1);
                paintCanvas.noFill();
                paintCanvas.stroke(183, 0, 255, 50);
                paintCanvas.ellipse(mappedX, mappedY, brushSize / 10);
                paintCanvas.pop();
            } else if (colorCategory === 'pink') {
                // Draw pink fat circles
                ...
                paintCanvas.strokeWeight(1);
                paintCanvas.noFill();
                paintCanvas.stroke(247, 183, 231, 50);
                paintCanvas.ellipse(mappedX, mappedY, brushSize * 2, brushSize);
                paintCanvas.pop();
            } else {
                // Draw regular ellipse if color is not categorized
                paintCanvas.push();
                paintCanvas.strokeWeight(1);
                paintCanvas.stroke(200, 200, 200, 50);
                paintCanvas.noFill();
                paintCanvas.ellipse(mappedX, mappedY, brushSize, brushSize);
                paintCanvas.pop();
                //ellipses.push({ x: mappedX, y: mappedY, type: "regular" }); // Store ellipse information
